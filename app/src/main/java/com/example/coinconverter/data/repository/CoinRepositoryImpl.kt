...
import com.example.coinconverter.core.exceptions.RemoteException
import com.example.coinconverter.data.database.AppDatabase
import com.example.coinconverter.data.model.ErrorResponse
import com.example.coinconverter.data.model.ExchangeResponseValue
import com.example.coinconverter.data.services.AwesomeService
...
class CoinRepositoryImpl(
    ...
    override suspend fun getExchangeValue(coins: String) = flow {
        try {
            ...
            // {"status":484,"code":"CoinNotExists","message":"moeda nao encontrada USD-USD}
